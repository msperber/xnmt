...
nheads = 8
nlayers = 2
vocab = Vocab(vocab_file = "/project/data-audio/tedlium-multi/parallel/vocab/en-de-es-fr.lc.no-numbers-punct.vocab")
# vocab = Vocab(vocab_file = "/Users/matthias/Desktop/en-de-es-fr.lc.no-numbers-punct.vocab")
...
#             ca1 = np.corrcoef(self_att_ax1, cross_att_sum)[0,1]
  ...
  print(axis1_avg_arr)
  print("-----")
  with open("/home/msperber/experiments/attention-heads/165.2.dotprod.yaml", "w") as f_out:
...
# with open("/Users/matthias/Desktop/165.1.yaml", 'r') as f:
#   yaml_results = yaml.load(f)
#   data = yaml_results["axis1_avg_arr"]
...
#   ax.set_xticklabels(['']+valid_vocab, fontsize=8, minor=True)
#   ax.set_xticklabels(['']*20, fontsize=8)
#   ax.matshow(data_sel)
#   ax.set_aspect('auto')
#   fig.savefig("/Users/matthias/Desktop/165.1.png", dpi=120)
#   fig.clf()
#   plt.close('all')
#   
